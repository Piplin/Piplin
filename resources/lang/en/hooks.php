...
return [
    ...
    'succeeded'                  => 'Succeeded',
    'failed'                     => 'Failed',
    'on_task_success'            => 'Task Succeeded',
    'on_task_failure'            => 'Task Failed',
    'custom'                     => 'Custom',
    'slack'                      => 'Slack',
    'dingtalk'                   => 'Dingtalk',
    'mail'                       => 'E-mail',
    ...
    'commit'                     => 'Commit',
    'committer'                  => 'Committer',
    'task_reason'                => 'Task reason - :reason',
    'task_success_slack_message' => ':white_check_mark: Task %s successful! :smile:',
    'task_failed_slack_message'  => ':x: Task %s failed! :cry:',

    // Dingtalk
    'task_success_ding_message' => 'Task %s successful!',
    'task_failed_ding_message'  => ':Task %s failed!',
    ...
    'task_success_email_subject' => 'Task Finished',
    'task_success_email_message' => 'The task was successful',
    'task_failed_email_subject'  => 'Task Failed',
    'task_failed_email_message'  => 'The task has failed',
];
