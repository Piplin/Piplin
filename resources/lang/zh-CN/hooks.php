...
return [
    ...
    'none'                       => '该项目还没有设置任何推送',
    'integration_help'           => '通过集成第三方服务，Piplin可实现对项目的任务状态进行实时推送。',
    'name'                       => '名称',
    'type'                       => '类型',
    ...
    'succeeded'                  => '成功',
    'failed'                     => '失败',
    'on_task_success'            => '任务成功',
    'on_task_failure'            => '任务失败',
    'custom'                     => 'Webhook',
    'slack'                      => 'Slack',
    'dingtalk'                   => '钉钉',
    'mail'                       => '邮件',
    ...
    'commit'                     => '代码版本号',
    'committer'                  => '代码提交者',
    'task_reason'                => '任务原因 - :reason',
    'task_success_slack_message' => ':white_check_mark: 任务 %s 执行成功! :smile:',
    'task_failed_slack_message'  => ':x: 任务 %s 执行失败! :cry:',

    // Dingtalk
    'task_success_ding_message'  => '任务 %s 执行成功!',
    'task_failed_ding_message'   => '任务 %s 执行失败!',
    'at_mobiles'                 => '被@人的手机号',
    'is_at_all'                  => '@所有人',
    ...
    'last_commit'                => '代码版本号',
    'reason'                     => '任务原因 - :reason',
    'task_success_email_subject' => '任务已完成',
    'task_success_email_message' => '本次任务已执行成功',
    'task_failed_email_subject'  => '任务失败',
    'task_failed_email_message'  => '本次任务执行失败了',
];
