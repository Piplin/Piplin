...
<div class="pull-right">
    <button type="button" class="btn btn-primary" title="{{ trans('tips.create') }}" data-toggle="modal" data-target="#tip"><span class="ion ion-plus-round"></span> {{ trans('tips.create') }}</button>
</div>
@stop
