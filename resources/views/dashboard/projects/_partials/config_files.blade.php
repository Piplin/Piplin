<div class="box">
    <div class="box-header">
        <div class="pull-right">
            <button type="button" {{ $current_user->is_admin ?: 'disabled="true"' }} class="btn btn-primary" title="{{ trans('configFiles.create') }}" data-toggle="modal" data-target="#configfile"><span class="fixhub fixhub-plus"></span> {{ trans('configFiles.create') }}</button>
        </div>
    ...
    <script type="text/template" id="configfiles-template">
        ...
        <td>
            <div class="btn-group pull-right">
                ...
                <button type="button" {{ $current_user->is_admin ?: 'disabled="true"' }} class="btn btn-default btn-edit" title="{{ trans('configFiles.edit') }}" data-toggle="modal" data-backdrop="static" data-target="#configfile"><i class="fixhub fixhub-edit"></i></button>
