            ...
            <form class="form-horizontal" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="environment_name">{{ trans('environments.name') }} <i class="ion ion-help-buoy" data-toggle="tooltip" data-placement="right" title="{{ trans('environments.example') }}"></i></label>
						<div class="col-sm-9">
