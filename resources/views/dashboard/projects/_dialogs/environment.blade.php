    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fixhub fixhub-environment"></i> <span>{{ trans('environments.create') }}</span></h4>
            </div>
            <form class="form-horizontal" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="callout callout-danger">
                        <i class="fixhub fixhub-warning"></i> {{ trans('environments.warning') }}
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="environment_name">{{ trans('environments.name') }} <i class="fixhub fixhub-help text-gray" data-toggle="tooltip" data-placement="right" title="{{ trans('environments.example') }}"></i></label>
						<div class="col-sm-9">
