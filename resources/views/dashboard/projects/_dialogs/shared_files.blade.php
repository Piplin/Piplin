        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="file">{{ trans('sharedFiles.file') }} <i class="ion ion-help" data-toggle="tooltip" data-placement="right" title="{{ trans('sharedFiles.example') }}"></i></label>
                        <div class="col-sm-9">
